...
(int verbose, double tiny)
{
  ...
  CHECK_MALLOC (sys0, "check_solve_res_3fts_a");
  sys0->version = 2; // FTS
  ...
  CHECK_MALLOC (sys1, "check_solve_res_3fts_a");
  sys1->version = 2; // FTS
  ...
  CHECK_MALLOC (u, "check_solve_res_3fts_a");
  CHECK_MALLOC (o, "check_solve_res_3fts_a");
  CHECK_MALLOC (e, "check_solve_res_3fts_a");
  for (int i = 0; i < np * 3; i ++)
    {
      u[i] = drand48();
      o[i] = drand48();
  ...
  CHECK_MALLOC (f0, "check_solve_res_3fts_a");
  CHECK_MALLOC (t0, "check_solve_res_3fts_a");
  CHECK_MALLOC (s0, "check_solve_res_3fts_a");
  ...
  CHECK_MALLOC (f1, "check_solve_res_3fts_a");
  CHECK_MALLOC (t1, "check_solve_res_3fts_a");
  CHECK_MALLOC (s1, "check_solve_res_3fts_a");
...
(int verbose, double tiny)
{
  ...
  // monodisperse
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_res_3fts_b");
  sys0->version = 2; // FTS
  ...
  // polydisperse
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_res_3fts_b");
  sys1->version = 2; // FTS
  ...
  double *o = (double *)malloc (sizeof (double) * np * 3);
  double *e = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (u, "check_solve_res_3fts_b");
  CHECK_MALLOC (o, "check_solve_res_3fts_b");
  CHECK_MALLOC (e, "check_solve_res_3fts_b");
  for (int i = 0; i < np * 3; i ++)
    {
      u[i] = drand48();
      o[i] = drand48();
  ...
  double *t0 = (double *)malloc (sizeof (double) * np * 3);
  double *s0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f0, "check_solve_res_3fts_b");
  CHECK_MALLOC (t0, "check_solve_res_3fts_b");
  CHECK_MALLOC (s0, "check_solve_res_3fts_b");

  double *f1 = (double *)malloc (sizeof (double) * np * 3);
  double *t1 = (double *)malloc (sizeof (double) * np * 3);
  double *s1 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f1, "check_solve_res_3fts_b");
  CHECK_MALLOC (t1, "check_solve_res_3fts_b");
  CHECK_MALLOC (s1, "check_solve_res_3fts_b");


  solve_res_3fts_new (sys0,
		      u, o, e,
		      f0, t0, s0);
 ...
 int verbose, double tiny)
{
  ...
  // monodisplers
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_res_3fts_b2");
  sys0->version = 2; // FTS
  ...
  CHECK_MALLOC (u0, "check_solve_res_3fts_b2");
  CHECK_MALLOC (o0, "check_solve_res_3fts_b2");
  CHECK_MALLOC (e0, "check_solve_res_3fts_b2");
  for (int i = 0; i < np * 3; i ++)
    {
      u0[i] = drand48();
      o0[i] = drand48();
  ...
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_res_3fts_b2");
  sys1->version = 2; // FTS
  ...
  CHECK_MALLOC (u1, "check_solve_res_3fts_b2");
  CHECK_MALLOC (o1, "check_solve_res_3fts_b2");
  CHECK_MALLOC (e1, "check_solve_res_3fts_b2");
  // scale
  for (int i = 0; i < np * 3; i ++)
    {
      u1[i] = u0[i] / scale;
      o1[i] = o0[i] / (scale * scale);
    }
  for (int i = 0; i < np * 5; i ++)
    {
  ...
  double *t0 = (double *)malloc (sizeof (double) * np * 3);
  double *s0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f0, "check_solve_res_3fts_b2");
  CHECK_MALLOC (t0, "check_solve_res_3fts_b2");
  CHECK_MALLOC (s0, "check_solve_res_3fts_b2");

  double *f1 = (double *)malloc (sizeof (double) * np * 3);
  double *t1 = (double *)malloc (sizeof (double) * np * 3);
  double *s1 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f1, "check_solve_res_3fts_b2");
  CHECK_MALLOC (t1, "check_solve_res_3fts_b2");
  CHECK_MALLOC (s1, "check_solve_res_3fts_b2");
...
(int verbose, double tiny)
{
  ...
  // old
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_res_3fts_c");
  sys0->version = 2; // FTS
  ...
  // new
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_res_3fts_c");
  sys1->version = 2; // FTS
  ...
  double *o = (double *)malloc (sizeof (double) * np * 3);
  double *e = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (u, "check_solve_res_3fts_c");
  CHECK_MALLOC (o, "check_solve_res_3fts_c");
  CHECK_MALLOC (e, "check_solve_res_3fts_c");
  for (int i = 0; i < np * 3; i ++)
    {
      u[i] = drand48();
      o[i] = drand48();
  ...
  double *t0 = (double *)malloc (sizeof (double) * np * 3);
  double *s0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f0, "check_solve_res_3fts_c");
  CHECK_MALLOC (t0, "check_solve_res_3fts_c");
  CHECK_MALLOC (s0, "check_solve_res_3fts_c");

  double *f1 = (double *)malloc (sizeof (double) * np * 3);
  double *t1 = (double *)malloc (sizeof (double) * np * 3);
  double *s1 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f1, "check_solve_res_3fts_c");
  CHECK_MALLOC (t1, "check_solve_res_3fts_c");
  CHECK_MALLOC (s1, "check_solve_res_3fts_c");
...
(int verbose, double tiny)
{
  ...
  // mono
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_res_3fts_d");
  sys0->version = 2; // FTS
  ...
  */
  ...
  // poly (a=1)
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_res_3fts_d");
  sys1->version = 2; // FTS
  ...
  double *o = (double *)malloc (sizeof (double) * np * 3);
  double *e = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (u, "check_solve_res_3fts_d");
  CHECK_MALLOC (o, "check_solve_res_3fts_d");
  CHECK_MALLOC (e, "check_solve_res_3fts_d");
  for (int i = 0; i < np * 3; i ++)
    {
      u[i] = drand48();
      o[i] = drand48();
  ...
  double *t0 = (double *)malloc (sizeof (double) * np * 3);
  double *s0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f0, "check_solve_res_3fts_d");
  CHECK_MALLOC (t0, "check_solve_res_3fts_d");
  CHECK_MALLOC (s0, "check_solve_res_3fts_d");

  double *f1 = (double *)malloc (sizeof (double) * np * 3);
  double *t1 = (double *)malloc (sizeof (double) * np * 3);
  double *s1 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f1, "check_solve_res_3fts_d");
  CHECK_MALLOC (t1, "check_solve_res_3fts_d");
  CHECK_MALLOC (s1, "check_solve_res_3fts_d");
 ...
 int verbose, double tiny)
{
  ...
  // mono
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_res_3fts_d2");
  sys0->version = 2; // FTS
  ...
  CHECK_MALLOC (a0, "check_solve_res_3fts_d2");
  for (int i = 0; i < np; i ++)
    {
      a0[i] = 1.0;
    }
  ...
  double *o0 = (double *)malloc (sizeof (double) * np * 3);
  double *e0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (u0, "check_solve_res_3fts_d2");
  CHECK_MALLOC (o0, "check_solve_res_3fts_d2");
  CHECK_MALLOC (e0, "check_solve_res_3fts_d2");
  for (int i = 0; i < np * 3; i ++)
    {
      u0[i] = drand48();
      o0[i] = drand48();
  ...
  // polydisperse (a = "scale")
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_res_3fts_d2");
  sys1->version = 2; // FTS
  ...
  CHECK_MALLOC (a1, "check_solve_res_3fts_d2");
  for (int i = 0; i < np; i ++)
    {
      a1[i] = a0[i] * scale;
    }
  ...
  double *t0 = (double *)malloc (sizeof (double) * np * 3);
  double *s0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f0, "check_solve_res_3fts_d2");
  CHECK_MALLOC (t0, "check_solve_res_3fts_d2");
  CHECK_MALLOC (s0, "check_solve_res_3fts_d2");

  double *f1 = (double *)malloc (sizeof (double) * np * 3);
  double *t1 = (double *)malloc (sizeof (double) * np * 3);
  double *s1 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f1, "check_solve_res_3fts_d2");
  CHECK_MALLOC (t1, "check_solve_res_3fts_d2");
  CHECK_MALLOC (s1, "check_solve_res_3fts_d2");
