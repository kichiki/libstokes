...
(int verbose, double tiny)
{
  ...
  CHECK_MALLOC (sys0, "check_solve_mob_lub_3fts_a");
  sys0->version = 2; // FTS
  ...
  CHECK_MALLOC (sys1, "check_solve_mob_lub_3fts_a");
  sys1->version = 2; // FTS
  ...
  CHECK_MALLOC (f, "check_solve_mob_lub_3fts_a");
  CHECK_MALLOC (t, "check_solve_mob_lub_3fts_a");
  CHECK_MALLOC (e, "check_solve_mob_lub_3fts_a");
  for (int i = 0; i < np * 3; i ++)
    {
      f[i] = drand48();
      t[i] = drand48();
  ...
  CHECK_MALLOC (u0, "check_solve_mob_lub_3fts_a");
  CHECK_MALLOC (o0, "check_solve_mob_lub_3fts_a");
  CHECK_MALLOC (s0, "check_solve_mob_lub_3fts_a");
  ...
  CHECK_MALLOC (u1, "check_solve_mob_lub_3fts_a");
  CHECK_MALLOC (o1, "check_solve_mob_lub_3fts_a");
  CHECK_MALLOC (s1, "check_solve_mob_lub_3fts_a");
...
(int verbose, double tiny)
{
  ...
  // old
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_mob_lub_3fts_c");
  sys0->version = 2; // FTS
  ...
  // new
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_mob_lub_3fts_c");
  sys1->version = 2; // FTS
  ...
  double *t = (double *)malloc (sizeof (double) * np * 3);
  double *e = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f, "check_solve_mob_lub_3fts_c");
  CHECK_MALLOC (t, "check_solve_mob_lub_3fts_c");
  CHECK_MALLOC (e, "check_solve_mob_lub_3fts_c");
  for (int i = 0; i < np * 3; i ++)
    {
      f[i] = drand48();
      t[i] = drand48();
  ...
  double *o0 = (double *)malloc (sizeof (double) * np * 3);
  double *s0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (u0, "check_solve_mob_lub_3fts_c");
  CHECK_MALLOC (o0, "check_solve_mob_lub_3fts_c");
  CHECK_MALLOC (s0, "check_solve_mob_lub_3fts_c");

  double *u1 = (double *)malloc (sizeof (double) * np * 3);
  double *o1 = (double *)malloc (sizeof (double) * np * 3);
  double *s1 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (u1, "check_solve_mob_lub_3fts_c");
  CHECK_MALLOC (o1, "check_solve_mob_lub_3fts_c");
  CHECK_MALLOC (s1, "check_solve_mob_lub_3fts_c");
