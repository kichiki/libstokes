 ...
 int verbose, double tiny)
{
  ...
  // monodisplers
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_res_lub_3fts_b2");
  sys0->version = 2; // FTS
  ...
  CHECK_MALLOC (u0, "check_solve_res_lub_3fts_b2");
  CHECK_MALLOC (o0, "check_solve_res_lub_3fts_b2");
  CHECK_MALLOC (e0, "check_solve_res_lub_3fts_b2");
  for (int i = 0; i < np * 3; i ++)
    {
      u0[i] = drand48();
      o0[i] = drand48();
  ...
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_res_lub_3fts_b2");
  sys1->version = 2; // FTS
  ...
  CHECK_MALLOC (u1, "check_solve_res_lub_3fts_b2");
  CHECK_MALLOC (o1, "check_solve_res_lub_3fts_b2");
  CHECK_MALLOC (e1, "check_solve_res_lub_3fts_b2");
  // scale
  for (int i = 0; i < np * 3; i ++)
    {
      u1[i] = u0[i] / scale;
  ...
  double *t0 = (double *)malloc (sizeof (double) * np * 3);
  double *s0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f0, "check_solve_res_lub_3fts_b2");
  CHECK_MALLOC (t0, "check_solve_res_lub_3fts_b2");
  CHECK_MALLOC (s0, "check_solve_res_lub_3fts_b2");

  double *f1 = (double *)malloc (sizeof (double) * np * 3);
  double *t1 = (double *)malloc (sizeof (double) * np * 3);
  double *s1 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f1, "check_solve_res_lub_3fts_b2");
  CHECK_MALLOC (t1, "check_solve_res_lub_3fts_b2");
  CHECK_MALLOC (s1, "check_solve_res_lub_3fts_b2");
 ...
 int verbose, double tiny)
{
  ...
  // mono
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_res_lub_3fts_d2");
  sys0->version = 2; // FTS
  ...
  CHECK_MALLOC (a0, "check_solve_res_lub_3fts_d2");
  for (int i = 0; i < np; i ++)
    {
      a0[i] = 1.0;
    }
  ...
  double *o0 = (double *)malloc (sizeof (double) * np * 3);
  double *e0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (u0, "check_solve_res_lub_3fts_d2");
  CHECK_MALLOC (o0, "check_solve_res_lub_3fts_d2");
  CHECK_MALLOC (e0, "check_solve_res_lub_3fts_d2");
  for (int i = 0; i < np * 3; i ++)
    {
      u0[i] = drand48();
      o0[i] = drand48();
  ...
  // polydisperse (a = "scale")
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_res_lub_3fts_d2");
  sys1->version = 2; // FTS
  ...
  CHECK_MALLOC (a1, "check_solve_res_lub_3fts_d2");
  for (int i = 0; i < np; i ++)
    {
      a1[i] = a0[i] * scale;
    }
  ...
  double *t0 = (double *)malloc (sizeof (double) * np * 3);
  double *s0 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f0, "check_solve_res_lub_3fts_d2");
  CHECK_MALLOC (t0, "check_solve_res_lub_3fts_d2");
  CHECK_MALLOC (s0, "check_solve_res_lub_3fts_d2");

  double *f1 = (double *)malloc (sizeof (double) * np * 3);
  double *t1 = (double *)malloc (sizeof (double) * np * 3);
  double *s1 = (double *)malloc (sizeof (double) * np * 5);
  CHECK_MALLOC (f1, "check_solve_res_lub_3fts_d2");
  CHECK_MALLOC (t1, "check_solve_res_lub_3fts_d2");
  CHECK_MALLOC (s1, "check_solve_res_lub_3fts_d2");
