/* header file for check-ewald-3fts-new_mix_lub.c --
 ...
 */
#ifndef	_CHECK_EWALD_3FTS_NEW_MIX_LUB_H_
#define	_CHECK_EWALD_3FTS_NEW_MIX_LUB_H_
...
#endif /* !_CHECK_EWALD_3FTS_NEW_MIX_LUB_H_ */
