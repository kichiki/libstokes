 ...
 int verbose, double tiny)
{
  ...
  // monodisplers
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_mix_3fts_b2");
  sys0->version = 2; // FTS
  ...
  CHECK_MALLOC (f0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (t0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (e0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (uf0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (of0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (ef0, "check_solve_mix_3fts_b2");
  for (int i = 0; i < nm * 3; i ++)
    {
      f0[i] = drand48();
      t0[i] = drand48();
  ...
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_mix_3fts_b2");
  sys1->version = 2; // FTS
  ...
  CHECK_MALLOC (f1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (t1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (e1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (uf1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (of1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (ef1, "check_solve_mix_3fts_b2");
  for (int i = 0; i < nm * 3; i ++)
    {
      // F
      f1[i] = f0[i];
  ...
  double *tf0 = (double *)malloc (sizeof (double) * nf * 3);
  double *sf0 = (double *)malloc (sizeof (double) * nf * 5);
  CHECK_MALLOC (u0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (o0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (s0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (ff0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (tf0, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (sf0, "check_solve_mix_3fts_b2");
  ...
  double *tf1 = (double *)malloc (sizeof (double) * nf * 3);
  double *sf1 = (double *)malloc (sizeof (double) * nf * 5);
  CHECK_MALLOC (u1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (o1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (s1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (ff1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (tf1, "check_solve_mix_3fts_b2");
  CHECK_MALLOC (sf1, "check_solve_mix_3fts_b2");
 ...
 int verbose, double tiny)
{
  ...
  // mono
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_mix_3fts_d2");
  sys0->version = 2; // FTS
  ...
  CHECK_MALLOC (a0, "check_solve_mix_3fts_d2");
  for (int i = 0; i < np; i ++)
    {
      a0[i] = 1.0;
    }
  ...
  double *of0 = (double *)malloc (sizeof (double) * nf * 3);
  double *ef0 = (double *)malloc (sizeof (double) * nf * 5);
  CHECK_MALLOC (f0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (t0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (e0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (uf0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (of0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (ef0, "check_solve_mix_3fts_d2");
  for (int i = 0; i < nm * 3; i ++)
    {
      f0[i] = drand48();
      t0[i] = drand48();
  ...
  // polydisperse (a = "scale")
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_mix_3fts_d2");
  sys1->version = 2; // FTS
  ...
  CHECK_MALLOC (a1, "check_solve_mix_3fts_d2");
  for (int i = 0; i < np; i ++)
    {
      a1[i] = a0[i] * scale;
    }
  ...
  double *of1 = (double *)malloc (sizeof (double) * nf * 3);
  double *ef1 = (double *)malloc (sizeof (double) * nf * 5);
  CHECK_MALLOC (f1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (t1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (e1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (uf1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (of1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (ef1, "check_solve_mix_3fts_d2");
  for (int i = 0; i < nm * 3; i ++)
    {
      // F
      f1[i] = f0[i];
  ...
  double *tf0 = (double *)malloc (sizeof (double) * nf * 3);
  double *sf0 = (double *)malloc (sizeof (double) * nf * 5);
  CHECK_MALLOC (u0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (o0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (s0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (ff0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (tf0, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (sf0, "check_solve_mix_3fts_d2");
  ...
  double *tf1 = (double *)malloc (sizeof (double) * nf * 3);
  double *sf1 = (double *)malloc (sizeof (double) * nf * 5);
  CHECK_MALLOC (u1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (o1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (s1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (ff1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (tf1, "check_solve_mix_3fts_d2");
  CHECK_MALLOC (sf1, "check_solve_mix_3fts_d2");
