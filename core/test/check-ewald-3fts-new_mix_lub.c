...
(int verbose, double tiny)
{
  ...
  CHECK_MALLOC (sys0, "check_solve_mix_lub_3fts_a");
  sys0->version = 2; // FTS
  ...
  CHECK_MALLOC (sys1, "check_solve_mix_lub_3fts_a");
  sys1->version = 2; // FTS
  ...
  CHECK_MALLOC (f, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (t, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (e, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (uf, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (of, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (ef, "check_solve_mix_lub_3fts_a");
  ...
  CHECK_MALLOC (u0, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (o0, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (s0, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (ff0, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (tf0, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (sf0, "check_solve_mix_lub_3fts_a");
  ...
  CHECK_MALLOC (u1, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (o1, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (s1, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (ff1, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (tf1, "check_solve_mix_lub_3fts_a");
  CHECK_MALLOC (sf1, "check_solve_mix_lub_3fts_a");
...
(int verbose, double tiny)
{
  ...
  // old
  struct stokes *sys0 = stokes_init ();
  CHECK_MALLOC (sys0, "check_solve_mix_lub_3fts_c");
  sys0->version = 2; // FTS
  ...
  // new
  struct stokes *sys1 = stokes_init ();
  CHECK_MALLOC (sys1, "check_solve_mix_lub_3fts_c");
  sys1->version = 2; // FTS
  ...
  double *of = (double *)malloc (sizeof (double) * nf * 3);
  double *ef = (double *)malloc (sizeof (double) * nf * 5);
  CHECK_MALLOC (f, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (t, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (e, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (uf, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (of, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (ef, "check_solve_mix_lub_3fts_c");
  for (int i = 0; i < nm * 3; i ++)
    {
      f[i] = drand48();
      t[i] = drand48();
  ...
  double *tf0 = (double *)malloc (sizeof (double) * nf * 3);
  double *sf0 = (double *)malloc (sizeof (double) * nf * 5);
  CHECK_MALLOC (u0, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (o0, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (s0, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (ff0, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (tf0, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (sf0, "check_solve_mix_lub_3fts_c");
  ...
  double *tf1 = (double *)malloc (sizeof (double) * nf * 3);
  double *sf1 = (double *)malloc (sizeof (double) * nf * 5);
  CHECK_MALLOC (u1, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (o1, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (s1, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (ff1, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (tf1, "check_solve_mix_lub_3fts_c");
  CHECK_MALLOC (sf1, "check_solve_mix_lub_3fts_c");
