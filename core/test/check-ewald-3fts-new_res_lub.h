/* header file for check-ewald-3fts-new_res_lub.c --
 ...
 */
#ifndef	_CHECK_EWALD_3FTS_NEW_RES_LUB_H_
#define	_CHECK_EWALD_3FTS_NEW_RES_LUB_H_
...
#endif /* !_CHECK_EWALD_3FTS_NEW_RES_LUB_H_ */
