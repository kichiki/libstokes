 ...
 * $Id: ewald-2fts.c,v 1.7 2007/03/07 22:26:16 kichiki Exp $
 *
		...
		double *f, double *t, double *s)
{
  ...
  if (u3 == NULL
      ...
      || e3 == NULL)
    {
      fprintf (stderr, "allocation error in solve_res_2fts ().\n");
      exit (1);
    }
		...
		double *u, double *o, double *s)
{
  ...
  if (f3 == NULL
      || e3 == NULL)
    {
      fprintf (stderr, "allocation error in solve_mob_2fts ().\n");
      exit (1);
    }
		...
		double *ff, double *tf, double *sf)
{
  ...
  if (f3 == NULL
      ...
      || ef3 == NULL)
    {
      fprintf (stderr, "allocation error in solve_mix_2fts ().\n");
      exit (1);
    }
		    ...
		    double *f, double *t, double *s)
{
  ...
  solve_res_lub_3fts (sys, u3, o3, e3,
		      f, t, s);
