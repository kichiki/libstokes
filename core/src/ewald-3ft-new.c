...
#include "lub-new.h" // calc_lub_3ft_new()

#include "ewald-3ft-new.h"
 ...
 double *f, double *t)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_res_3ft_0_new :"
  ...
  CHECK_MALLOC (b, "solve_res_3ft_0_new");
  CHECK_MALLOC (x, "solve_res_3ft_0_new");
 ...
 double *f, double *t)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_res_3ft_new :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  CHECK_MALLOC (u0, "solve_res_3ft_new");
  CHECK_MALLOC (o0, "solve_res_3ft_new");
 ...
 double *u, double *o)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_mob_3ft_new :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  double *b = (double *) malloc (sizeof (double) * n6);
  double *x = (double *) malloc (sizeof (double) * n6);
  CHECK_MALLOC (b, "solve_mob_3ft_new");
  CHECK_MALLOC (x, "solve_mob_3ft_new");

  /* the main calculation is done in the the fluid-rest frame;
   * u(x)=0 as |x|-> infty */

  set_ft_by_FT (np, x, f, t);
  atimes_3all_new (n6, x, b, (void *) sys); // sys->version is 1 (FT)
 ...
 double *b)
{
  ...
  CHECK_MALLOC (x, "calc_b_mix_3ft_new");
  CHECK_MALLOC (v3_0, "calc_b_mix_3ft_new");
 ...
 */
static void
atimes_mix_3ft_new (int n, const double *x, double *y, void * user_data)
{
  ...
  CHECK_MALLOC (z, "atimes_mix_3ft_new");
  CHECK_MALLOC (v3_0, "atimes_mix_3ft_new");
  CHECK_MALLOC (u, "atimes_mix_3ft_new");
  CHECK_MALLOC (o, "atimes_mix_3ft_new");
  CHECK_MALLOC (ff, "atimes_mix_3ft_new");
  CHECK_MALLOC (tf, "atimes_mix_3ft_new");
  ...
  atimes_3all_new (n, y, z, (void *) sys); // sys->version is 1 (FT)
 ...
 double *ff, double *tf)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_mix_3ft_new :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  double *b = (double *) malloc (sizeof (double) * n6);
  double *x = (double *) malloc (sizeof (double) * n6);
  CHECK_MALLOC (uf0, "solve_mix_3ft_new");
  CHECK_MALLOC (of0, "solve_mix_3ft_new");
  CHECK_MALLOC (b, "solve_mix_3ft_new");
  CHECK_MALLOC (x, "solve_mix_3ft_new");
  ...
  calc_b_mix_3ft_new (sys, f, t, uf0, of0, b);
  free (uf0);
  free (of0);

  solve_iter (n6, b, x,
	      atimes_mix_3ft_new, (void *)sys,
	      sys->it);
 ...
 double *f, double *t)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_res_lub_3ft_0_new :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  CHECK_MALLOC (b, "solve_res_lub_3ft_0_new");
  CHECK_MALLOC (x, "solve_res_lub_3ft_0_new");
  CHECK_MALLOC (lub, "solve_res_lub_3ft_0_new");

  set_ft_by_FT (np, b, u, o);

  calc_lub_3ft_new (sys, b, lub);
  atimes_3all_new (n6, lub, x, (void *) sys);
  // sys->version is 1 (FT)
 ...
 double *f, double *t)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_res_lub_3ft_new :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  double *u0 = (double *) malloc (sizeof (double) * np * 3);
  double *o0 = (double *) malloc (sizeof (double) * np * 3);
  CHECK_MALLOC (u0, "solve_res_lub_3ft_new");
  CHECK_MALLOC (o0, "solve_res_lub_3ft_new");
 ...
 double *y, void *user_data)
{
  ...
  CHECK_MALLOC (lub, "atimes_mob_lub_3ft_new");

  calc_lub_3ft_new (sys, x, y);
 ...
 double *u, double *o)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_mob_lub_3ft_new :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  double *b = (double *) malloc (sizeof (double) * n6);
  double *x = (double *) malloc (sizeof (double) * n6);
  CHECK_MALLOC (b, "solve_mob_lub_3ft_new");
  CHECK_MALLOC (x, "solve_mob_lub_3ft_new");
  ...
  solve_iter (n6, b, x,
	      atimes_mob_lub_3ft_new, (void *)sys,
	      sys->it);
  // x = (I + M.L)^-1 . b
 ...
 double *b)
{
  ...
  double *v3_0 = (double *) malloc (sizeof (double) * n3);
  CHECK_MALLOC (x, "calc_b_mix_lub_3ft_new");
  CHECK_MALLOC (y, "calc_b_mix_lub_3ft_new");
  CHECK_MALLOC (v3_0, "calc_b_mix_lub_3ft_new");
  ...
  atimes_3all_new (n6, x, y, (void *) sys); // sys->version is 1 (FT)
 ...
 double *y, void * user_data)
{
  ...
  double *ff = (double *) malloc (sizeof (double) * nf3);
  double *tf = (double *) malloc (sizeof (double) * nf3);
  CHECK_MALLOC (w, "atimes_mix_lub_3ft_new");
  CHECK_MALLOC (z, "atimes_mix_lub_3ft_new");
  CHECK_MALLOC (v3_0, "atimes_mix_lub_3ft_new");
  CHECK_MALLOC (u, "atimes_mix_lub_3ft_new");
  CHECK_MALLOC (o, "atimes_mix_lub_3ft_new");
  CHECK_MALLOC (ff, "atimes_mix_lub_3ft_new");
  CHECK_MALLOC (tf, "atimes_mix_lub_3ft_new");
  ...
  atimes_3all_new (n, w, z, (void *) sys); // sys->version is 1 (FT)
 ...
 double *ff, double *tf)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_mix_lub_3ft_new :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  double *b = (double *) malloc (sizeof (double) * n6);
  double *x = (double *) malloc (sizeof (double) * n6);
  CHECK_MALLOC (uf0, "solve_mix_lub_3ft_new");
  CHECK_MALLOC (of0, "solve_mix_lub_3ft_new");
  CHECK_MALLOC (b, "solve_mix_lub_3ft_new");
  CHECK_MALLOC (x, "solve_mix_lub_3ft_new");
  ...
  calc_b_mix_lub_3ft_new (sys, f, t, uf0, of0, b);
  free (uf0);
  free (of0);

  solve_iter (n6, b, x,
	       atimes_mix_lub_3ft_new, (void *)sys,
	       sys->it);
