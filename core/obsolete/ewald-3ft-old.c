...
#include "ft.h"
#include "f.h"
#include "ewald-old.h" // atimes_3all_old()
#include "lub-old.h" // calc_lub_3ft_old()

#include "ewald-3ft-old.h"
 ...
 double *f, double *t)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_res_3ft_0_old :"
  ...
  CHECK_MALLOC (b, "solve_res_3ft_0_old");
  CHECK_MALLOC (x, "solve_res_3ft_0_old");
 ...
 double *f, double *t)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_res_3ft_old :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  CHECK_MALLOC (u0, "solve_res_3ft_old");
  CHECK_MALLOC (o0, "solve_res_3ft_old");
 ...
 double *u, double *o)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_mob_3ft_old :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  double *b = (double *) malloc (sizeof (double) * n6);
  double *x = (double *) malloc (sizeof (double) * n6);
  CHECK_MALLOC (b, "solve_mob_3ft_old");
  CHECK_MALLOC (x, "solve_mob_3ft_old");

  /* the main calculation is done in the the fluid-rest frame;
   * u(x)=0 as |x|-> infty */

  set_ft_by_FT (np, x, f, t);
  atimes_3all_old (n6, x, b, (void *) sys); // sys->version is 1 (FT)
 ...
 double *b)
{
  ...
  CHECK_MALLOC (x, "calc_b_mix_3ft_old");
  CHECK_MALLOC (v3_0, "calc_b_mix_3ft_old");
...
(int n, const double *x, double *y, void * user_data)
{
  ...
  CHECK_MALLOC (z, "atimes_mix_3ft_old");
  CHECK_MALLOC (v3_0, "atimes_mix_3ft_old");
  CHECK_MALLOC (u, "atimes_mix_3ft_old");
  CHECK_MALLOC (o, "atimes_mix_3ft_old");
  CHECK_MALLOC (ff, "atimes_mix_3ft_old");
  CHECK_MALLOC (tf, "atimes_mix_3ft_old");
  ...
  atimes_3all_old (n, y, z, (void *) sys); // sys->version is 1 (FT)
 ...
 double *ff, double *tf)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_mix_3ft_old :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  double *b = (double *) malloc (sizeof (double) * n6);
  double *x = (double *) malloc (sizeof (double) * n6);
  CHECK_MALLOC (uf0, "solve_mix_3ft_old");
  CHECK_MALLOC (of0, "solve_mix_3ft_old");
  CHECK_MALLOC (b, "solve_mix_3ft_old");
  CHECK_MALLOC (x, "solve_mix_3ft_old");
  ...
  calc_b_mix_3ft_old (sys, f, t, uf0, of0, b);
  free (uf0);
  free (of0);

  solve_iter (n6, b, x,
	      atimes_mix_3ft_old, (void *)sys,
	      sys->it);
 ...
 double *f, double *t)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_res_lub_3ft_0_old :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  CHECK_MALLOC (b, "solve_res_lub_3ft_0_old");
  CHECK_MALLOC (x, "solve_res_lub_3ft_0_old");
  CHECK_MALLOC (lub, "solve_res_lub_3ft_0_old");

  set_ft_by_FT (np, b, u, o);

  calc_lub_3ft_old (sys, b, lub);
  atimes_3all_old (n6, lub, x, (void *) sys);
  // sys->version is 1 (FT)
 ...
 double *f, double *t)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_res_lub_3ft_old :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  double *u0 = (double *) malloc (sizeof (double) * np * 3);
  double *o0 = (double *) malloc (sizeof (double) * np * 3);
  CHECK_MALLOC (u0, "solve_res_lub_3ft_old");
  CHECK_MALLOC (o0, "solve_res_lub_3ft_old");
 ...
 double *y, void *user_data)
{
  ...
  CHECK_MALLOC (lub, "atimes_mob_lub_3ft_old");

  calc_lub_3ft_old (sys, x, y);
 ...
 double *u, double *o)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_mob_lub_3ft_old :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  double *b = (double *) malloc (sizeof (double) * n6);
  double *x = (double *) malloc (sizeof (double) * n6);
  CHECK_MALLOC (b, "solve_mob_lub_3ft_old");
  CHECK_MALLOC (x, "solve_mob_lub_3ft_old");
  ...
  solve_iter (n6, b, x,
	      atimes_mob_lub_3ft_old, (void *)sys,
	      sys->it);
  // x = (I + M.L)^-1 . b
 ...
 double *b)
{
  ...
  double *v3_0 = (double *) malloc (sizeof (double) * n3);
  CHECK_MALLOC (x, "calc_b_mix_lub_3ft_old");
  CHECK_MALLOC (y, "calc_b_mix_lub_3ft_old");
  CHECK_MALLOC (v3_0, "calc_b_mix_lub_3ft_old");
  ...
  atimes_3all_old (n6, x, y, (void *) sys); // sys->version is 1 (FT)
 ...
 double *y, void * user_data)
{
  ...
  double *ff = (double *) malloc (sizeof (double) * nf3);
  double *tf = (double *) malloc (sizeof (double) * nf3);
  CHECK_MALLOC (w, "atimes_mix_lub_3ft_old");
  CHECK_MALLOC (z, "atimes_mix_lub_3ft_old");
  CHECK_MALLOC (v3_0, "atimes_mix_lub_3ft_old");
  CHECK_MALLOC (u, "atimes_mix_lub_3ft_old");
  CHECK_MALLOC (o, "atimes_mix_lub_3ft_old");
  CHECK_MALLOC (ff, "atimes_mix_lub_3ft_old");
  CHECK_MALLOC (tf, "atimes_mix_lub_3ft_old");
  ...
  atimes_3all_old (n, w, z, (void *) sys); // sys->version is 1 (FT)
 ...
 double *ff, double *tf)
{
  if (sys->version != 1)
    {
      fprintf (stderr, "libstokes solve_mix_lub_3ft_old :"
	       " the version is wrong. reset to FT\n");
      sys->version = 1;
    }
  ...
  if (np == nm)
    {
      solve_mob_lub_3ft_old (sys, f, t, u, o);
      return;
    }
  ...
  double *b = (double *) malloc (sizeof (double) * n6);
  double *x = (double *) malloc (sizeof (double) * n6);
  CHECK_MALLOC (uf0, "solve_mix_lub_3ft_old");
  CHECK_MALLOC (of0, "solve_mix_lub_3ft_old");
  CHECK_MALLOC (b, "solve_mix_lub_3ft_old");
  CHECK_MALLOC (x, "solve_mix_lub_3ft_old");
  ...
  calc_b_mix_lub_3ft_old (sys, f, t, uf0, of0, b);
  free (uf0);
  free (of0);

  solve_iter (n6, b, x,
	      atimes_mix_lub_3ft_old, (void *)sys,
	      sys->it);
