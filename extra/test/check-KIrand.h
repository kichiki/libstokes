/* header file for check-KIrand.c --
 * test code for KIrand.c
 * Copyright (C) 2008 Kengo Ichiki <kichiki@users.sourceforge.net>
 * $Id: check-KIrand.h,v 1.1 2008/06/01 17:05:48 kichiki Exp $
 *
 ...
 */
#ifndef	_CHECK_KIRAND_H_
#define	_CHECK_KIRAND_H_
